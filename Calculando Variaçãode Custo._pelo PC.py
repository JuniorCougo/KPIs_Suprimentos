...
#Realizando a tratativa pelo o valor do custo unitário do pedido
# Lendo apenas a tabela '2_PEDIDOS_II'
...
nome_arquivo = f"Variação_Custo_2024{data_hora_atual}.xlsx"
